...
import 'package:ungsocial/models/post_model.dart';
import 'package:ungsocial/models/user_model.dart';
import 'package:ungsocial/states/authen.dart';
...
class _MyServiceState extends State<MyService> {
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        CircleAvatar(
                          backgroundImage:
                              NetworkImage(postModels[index].urlAvaggarPost),
                        ),
  ...
  Future<void> processAddPost() async {
    ...
    PostModel postModel = PostModel(
        ...
        timePost: timePost,
        uidPost: user!.uid,
        urlAvaggarPost: userModel!.urlAvatar);
